...
pub fn set_feature_setting(
    ...
    state.set_feature_setting(id, &key, value).map_err(|e| e.to_string())
}
...
#[tauri::command]
pub fn save_rune_page(
    state: State<Arc<RunePageManager>>,
    page: RunePage,
) -> Result<(), String> {
